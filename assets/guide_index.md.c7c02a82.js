import{_ as s,o as n,c as a,a as l}from"./app.7c9dd543.js";const d=JSON.parse('{"title":"vue-draggable-plus","description":"","frontmatter":{"realPath":"docs/guide/index.md"},"headers":[{"level":2,"title":"使用说明","slug":"使用说明","link":"#使用说明","children":[]},{"level":2,"title":"解决痛点","slug":"解决痛点","link":"#解决痛点","children":[]},{"level":2,"title":"安装","slug":"安装","link":"#安装","children":[]},{"level":2,"title":"使用","slug":"使用","link":"#使用","children":[{"level":3,"title":"组件方式","slug":"组件方式","link":"#组件方式","children":[]},{"level":3,"title":"hooks 方式","slug":"hooks-方式","link":"#hooks-方式","children":[]},{"level":3,"title":"指令方式","slug":"指令方式","link":"#指令方式","children":[]}]}],"relativePath":"guide/index.md","lastUpdated":null}'),p={name:"guide/index.md"},o=l(`<h1 id="vue-draggable-plus" tabindex="-1">vue-draggable-plus <a class="header-anchor" href="#vue-draggable-plus" aria-hidden="true">#</a></h1><p>拖拽排序模块，支持 Vue&gt;=v3或 Vue &gt;=2.7，当然如果您是 vue2.6 一下用户，只需要导入 <code>@vue/composition-api</code> 就可以使用了，这都是 <a href="https://github.com/vueuse/vue-demi" target="_blank" rel="noreferrer">vue-demi</a> 赋予我们的能力。</p><h2 id="使用说明" tabindex="-1">使用说明 <a class="header-anchor" href="#使用说明" aria-hidden="true">#</a></h2><p>由于 <code>Sortablejs</code> 的 <code>vue3</code> 组件一直没有更新，已经跟 <code>vue3</code> 严重脱节，所以诞生了这个项目，这个组件是基于 <code>Sortablejs</code> 的，所以如果你想了解更多关于 <code>Sortablejs</code> 的信息，可以查看<a href="https://github.com/SortableJS/Sortable" target="_blank" rel="noreferrer">Sortablejs 官网</a>。</p><p>我们对此封装了多种用法，您可以使用组件的方式，也可以使用 <code>hooks</code> 的方式，也可以使用指令的方式，总有一款适合您。</p><h2 id="解决痛点" tabindex="-1">解决痛点 <a class="header-anchor" href="#解决痛点" aria-hidden="true">#</a></h2><p>在 <code>Sortablejs</code> 官方以往的 <code>Vue</code> 组件中，都是通过使用组件作为列表的直接子元素来实现拖拽列表，当我们使用一些组件库时，如果组件库中没有提供列表根元素的插槽，我们很难实现拖拽列表，vue-draggable-plus 完美解决了这个问题，它可以让你在任何元素上使用拖拽列表，我们可以使用指定元素的选择器，来获取到列表根元素，然后将列表根元素作为 <code>Sortablejs</code> 的 <code>container</code>，详情参考<a href="/vue-draggable-plus/en/demo/target-container/">指定目标容器</a>。</p><h2 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装" aria-hidden="true">#</a></h2><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki vp-code-dark"><code><span class="line"><span style="color:#C9D1D9;">npm install vue-draggable-plus</span></span>
...
<span class="line"><span style="color:#24292F;">}</span></span>
<span class="line"><span style="color:#24292F;">&lt;/</span><span style="color:#116329;">script</span><span style="color:#24292F;">&gt;</span></span>
<span class="line"></span></code></pre></div>`,16),e=[o];function t(c,r,y,D,i,F){return n(),a("div",null,e)}const u=s(p,[["render",t]]);export{d as __pageData,u as default};
